...
#
# Created: Sun Jun 23 05:20:42 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QtWidgets.QLabel(self.tab_wordTable)
        ...
        self.label_typingCorrect = QtWidgets.QLabel(self.tab_typing)
        self.label_typingCorrect.setEnabled(True)
        self.label_typingCorrect.setObjectName("label_typingCorrect")
        self.verticalLayout_18.addWidget(self.label_typingCorrect)
        ...
        self.label_typingFractionCorrect = QtWidgets.QLabel(self.tab_typing)
        self.label_typingFractionCorrect.setEnabled(True)
        self.label_typingFractionCorrect.setTextFormat(QtCore.Qt.PlainText)
        self.label_typingFractionCorrect.setObjectName("label_typingFractionCorrect")
        self.horizontalLayout_7.addWidget(self.label_typingFractionCorrect)
        ...
        self.pushButton_quizKnow = QtWidgets.QPushButton(self.tab_flashcards)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_quizKnow.sizePolicy().hasHeightForWidth())
        self.pushButton_quizKnow.setSizePolicy(sizePolicy)
        self.pushButton_quizKnow.setMinimumSize(QtCore.QSize(0, 64))
        self.pushButton_quizKnow.setObjectName("pushButton_quizKnow")
        self.horizontalLayout_4.addWidget(self.pushButton_quizKnow)
        self.pushButton_quizDontKnow = QtWidgets.QPushButton(self.tab_flashcards)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_quizDontKnow.sizePolicy().hasHeightForWidth())
        self.pushButton_quizDontKnow.setSizePolicy(sizePolicy)
        self.pushButton_quizDontKnow.setMinimumSize(QtCore.QSize(0, 64))
        self.pushButton_quizDontKnow.setObjectName("pushButton_quizDontKnow")
        self.horizontalLayout_4.addWidget(self.pushButton_quizDontKnow)
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.tab_statistics)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.comboBox_sessions = QtWidgets.QComboBox(self.tab_statistics)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_sessions.sizePolicy().hasHeightForWidth())
        self.comboBox_sessions.setSizePolicy(sizePolicy)
        self.comboBox_sessions.setObjectName("comboBox_sessions")
        self.horizontalLayout_13.addWidget(self.comboBox_sessions)
        self.pushButton_removeSession = QtWidgets.QPushButton(self.tab_statistics)
        self.pushButton_removeSession.setObjectName("pushButton_removeSession")
        self.horizontalLayout_13.addWidget(self.pushButton_removeSession)
        ...
        self.gridLayout_2.addWidget(self.comboBox_statistics, 0, 3, 1, 1)
        self.tableView_sessionData = QtWidgets.QTableView(self.tab_statistics)
        self.tableView_sessionData.setObjectName("tableView_sessionData")
        self.gridLayout_2.addWidget(self.tableView_sessionData, 1, 1, 1, 1)
        self.graphicsView_statistics = QtWidgets.QGraphicsView(self.tab_statistics)
        self.graphicsView_statistics.setObjectName("graphicsView_statistics")
        self.gridLayout_2.addWidget(self.graphicsView_statistics, 1, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QtWidgets.QApplication.translate("MainWindow", "Number of Cards: ", None, -1))
        ...
        self.label_typingCorrect.setText(QtWidgets.QApplication.translate("MainWindow", "Times Correct:", None, -1))
        ...
        self.label_typingFractionCorrect.setText(QtWidgets.QApplication.translate("MainWindow", "%0", None, -1))
        ...
        self.pushButton_quizKnow.setText(QtWidgets.QApplication.translate("MainWindow", "Know Word", None, -1))
        self.pushButton_quizDontKnow.setText(QtWidgets.QApplication.translate("MainWindow", "Don\'t Know", None, -1))
        ...
        self.pushButton_removeSession.setText(QtWidgets.QApplication.translate("MainWindow", "Delete", None, -1))
